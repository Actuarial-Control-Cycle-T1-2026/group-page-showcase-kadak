...
# DATA CLEANING
##################################################################
## removing NA entries from the dataset 
...
## add claim_count to sev dataset to combine both sheets
...
# removing additional symbols from the end of variable names 
worker_data_sev <- worker_data_sev |>
  mutate(across(
...
########################################
#4. Frequency of Claims adjusted per unit of exposure
########################################
...
#######################################
#5. Average base salary vs occupation
#######################################
...
#######################################
#6. Average claim amount vs injury type
#######################################
...
#######################################
#10. Claim Distribution by solar system 
#######################################
...
#counting the mean, min, max, etc whilst removing any NA values that are still present 
worker_data_sev %>%
